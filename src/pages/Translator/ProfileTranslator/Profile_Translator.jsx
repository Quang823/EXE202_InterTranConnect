...
const Profile_Translator = () => {
  ...
  useEffect(() => {
    const fetchCertificates = async (userId) => {
      try {
        const certs = await fetchTranslatorCertificates(userId);
        setCertificates(Array.isArray(certs) ? certs : []);
      } catch (err) {
        setCertificates([]);
      }
    };
    if (userData.id) fetchCertificates(userData.id);
  }, [userData.id]);
                      ...
                      <div key={index} className="certificate-item">
                        ...
                        <div className="certificate-content">
                          <div className="cert-field">
                            <div className="cert-label">Title</div>
                            <div className="cert-value">{cert.name}</div>
                          </div>
                          <div className="cert-field">
                            <div className="cert-label">Experience</div>
                            <div className="cert-value">{cert.experience}</div>
                          </div>
                          <div className="cert-field">
                            <div className="cert-label">Education</div>
                            <div className="cert-value">{cert.education}</div>
                          </div>
                          <div className="cert-field">
                            <div className="cert-label">Names</div>
            ...
            <div className="section-card">
              <div className="section-content">
                ...
                {certificates.length === 0 ? (
                  <div className="section-text">No certificates found.</div>
                ) : (
                  <div className="certificates-grid">
                    {certificates.map((cert, idx) => (
                      ...
                      >
                        <div className="certificate-content">
                          <div className="cert-field">
                            <div className="cert-label">Title</div>
                            <div className="cert-value">{cert.title}</div>
                          </div>
                          <div className="cert-field">
                            <div className="cert-label">Experience</div>
                            <div className="cert-value">{cert.experience}</div>
