    ...
    <div className="itc-container">
      ...
      <section className="itc-hero">
        <div className="itc-hero-content">
          <div className="itc-hero-text animate">
            ...
            <p>
              Join our global network of professional translators and
              interpreters to find meaningful work opportunities and grow your
              career in language services.
            </p>
          ...
          <div className="itc-hero-image animate">
            <img
              src="https://media.istockphoto.com/id/1364548726/photo/translate-language-online-learning-global-communication.jpg?s=612x612&w=0&k=20&c=KLhACgXNCIFZrABILSbRtT7erpBMWZVHj_AO67g4PWs="
              alt="Global translation network"
            />
      ...
      <section id="about" className="itc-about">
        <div className="itc-section-header animate">
          <h2>About Us</h2>
          <p>
            Discover why we're the leading platform for language professionals
          </p>
        </div>
        ...
        <div className="itc-about-content">
          <div className="itc-about-image animate">
            <img
              src="https://t4.ftcdn.net/jpg/11/11/01/05/360_F_1111010555_cqd9mAOYvQrI0k8PE8J3hsIP3pYo7Jua.jpg"
              alt="About InterTransConnect"
            />
          ...
          <div className="itc-about-text animate">
            <h3>Our Mission</h3>
            <p>
              Inter-TransConnect: Connecting translators and interpreters with
              businesses for seamless global communication.
            </p>
            ...
            <div className="itc-features">
              <div className="itc-feature">
                ...
                <div className="itc-feature-text">
                  ...
                  <p>
                    Connect with certified translators & interpreters worldwide
                  </p>
                </div>
              </div>
              ...
              <div className="itc-feature">
                ...
                <div className="itc-feature-text">
                  ...
                  <p>
                    Specialists in legal, medical, technical, and marketing
                    translations
                  </p>
                </div>
              </div>
          ...
          <div className="itc-tab-content animate">
            {activeTab === 0 && (
              <div className="itc-tab-panel">
                <div className="itc-tab-image">
                  <img
                    src="https://media.istockphoto.com/id/452753401/photo/hello.jpg?s=612x612&w=0&k=20&c=RBTDtJ0zrEqi8MjISgWXz7CW9OOVeHgZGrdxklphxAQ="
                ...
                <div className="itc-tab-text">
                  ...
                  <p>
                    Our network of professional translators provides accurate
                    and culturally appropriate translations for all types of
                    content, from technical documents to creative marketing
                    materials.
                  </p>
            ...
            {activeTab === 1 && (
              <div className="itc-tab-panel">
                <div className="itc-tab-image">
                  <img
                    src="https://www.lionbridge.com/content/lionbridge/en/content-transformation-services/interpretation-services/_jcr_content/root/responsivegrid/teaser_1366313247_co.coreimg.100.1440.jpeg/1746707209371/opi-web-healthcare-feature-800x694.jpeg"
                ...
                <div className="itc-tab-text">
                  ...
                  <p>
                    Our interpreters facilitate real-time communication across
                    language barriers for conferences, meetings, legal
            ...
            {activeTab === 2 && (
              <div className="itc-tab-panel">
                <div className="itc-tab-image">
                  <img
                    src="https://www.crystalhues.com/images/UploadedImages/BlogDocuments/ef49d5c0af.jpg"
                ...
                <div className="itc-tab-text">
                  ...
                  <p>
                    We adapt your content to specific markets, ensuring it
                    resonates with local audiences while maintaining your
            ...
            {activeTab === 3 && (
              <div className="itc-tab-panel">
                <div className="itc-tab-image">
                  <img
                    src="https://keycontent.com/wp-content/uploads/2023/06/AdobeStock_288510230.jpg"
                ...
                <div className="itc-tab-text">
                  ...
                  <p>
                    Our content creators develop original, engaging content in
                    multiple languages tailored to your target audience and
                    marketing goals.
                  </p>
                  <ul className="itc-check-list">
                    <li>
        ...
        <div className="itc-process">
          <div className="itc-process-step animate">
            ...
            <div className="itc-step-content">
              ...
              <p>
                Sign up and complete your professional profile with your
                language pairs, specializations, and experience.
              </p>
            </div>
          </div>
          ...
          <div className="itc-process-step animate">
            ...
            <div className="itc-step-content">
              ...
              <p>
                Submit your certifications, portfolio, and references to verify
                your qualifications.
              </p>
            </div>
          </div>
          ...
          <div className="itc-process-step animate">
            ...
            <div className="itc-step-content">
              ...
              <p>
                Submit proposals for projects and connect with clients from
                around the world.
              </p>
            </div>
          </div>
      ...
      <section className="itc-testimonials">
        <div className="itc-section-header animate">
          ...
          <p>
            Hear from translators and interpreters who have grown their careers
            with us
          </p>
        </div>
        ...
        <div className="itc-testimonial-grid">
          <div className="itc-testimonial animate">
            <div className="itc-testimonial-content">
              <p>
                "InterTransConnect has transformed my freelance translation
                career. I now have a steady stream of projects in my specialized
                field of medical translation."
              </p>
            </div>
          ...
          <div className="itc-testimonial animate">
            <div className="itc-testimonial-content">
              <p>
                "As a conference interpreter, finding consistent work was
                challenging until I joined InterTransConnect. Their platform
                connects me with global events and conferences."
              </p>
            </div>
            <div className="itc-testimonial-author">
              <img
          ...
          <div className="itc-testimonial animate">
            <div className="itc-testimonial-content">
              <p>
                "The specialized projects available through InterTransConnect
                have allowed me to focus exclusively on legal translation, which
      ...
      <section id="faq" className="itc-faq">
        ...
        <div className="itc-faq-container">
          <div className="itc-faq-list animate">
            <div
              className={`itc-faq-item ${activeFaq === 0 ? "active" : ""}`}
              onClick={() => toggleFaq(0)}
            >
              <div className="itc-faq-question">
                <h3>
                  How can I join InterTransConnect as a translator or
                  interpreter?
                </h3>
                <span className="itc-faq-icon">
                  {activeFaq === 0 ? <X /> : <ChevronRight />}
                </span>
              </div>
              <div className="itc-faq-answer">
                <p>
                  To join our platform, create an account on our website,
                  complete your professional profile with your language pairs,
                  specializations, and experience, upload your credentials for
                  verification, and once approved, you can start browsing and
            ...
            <div
              className={`itc-faq-item ${activeFaq === 1 ? "active" : ""}`}
              onClick={() => toggleFaq(1)}
            >
              <div className="itc-faq-question">
                <h3>
                  What types of projects are available on InterTransConnect?
                </h3>
                <span className="itc-faq-icon">
                  {activeFaq === 1 ? <X /> : <ChevronRight />}
                </span>
              </div>
              <div className="itc-faq-answer">
                <p>
                  Our platform offers a wide range of projects including
                  document translation, website localization, conference
                  interpretation, legal translation, medical interpretation,
                  technical documentation, marketing content, subtitling, and
                  more across various industries and language pairs.
                </p>
              </div>
            </div>

            <div
              className={`itc-faq-item ${activeFaq === 2 ? "active" : ""}`}
              onClick={() => toggleFaq(2)}
            >
              <div className="itc-faq-question">
                <h3>How do I get paid for completed projects?</h3>
                <span className="itc-faq-icon">
                  {activeFaq === 2 ? <X /> : <ChevronRight />}
                </span>
              </div>
              <div className="itc-faq-answer">
                <p>
                  We offer multiple payment options including direct deposit,
                  PayPal, and wire transfers. Payments are processed bi-weekly
                  for all completed and approved work. You can track your
                  earnings and payment status in your account dashboard.
                </p>
              </div>
            </div>

            <div
              className={`itc-faq-item ${activeFaq === 3 ? "active" : ""}`}
              onClick={() => toggleFaq(3)}
            >
              <div className="itc-faq-question">
                <h3>Is there a certification requirement to join?</h3>
                <span className="itc-faq-icon">
                  {activeFaq === 3 ? <X /> : <ChevronRight />}
                </span>
              </div>
              <div className="itc-faq-answer">
                <p>
                  While certification is preferred, we also consider experience
                  and skill level. All applicants undergo a thorough vetting
                  process including language proficiency tests. For certain
                  specialized fields like legal or medical translation, specific
            ...
            <div
              className={`itc-faq-item ${activeFaq === 4 ? "active" : ""}`}
              onClick={() => toggleFaq(4)}
            >
              <div className="itc-faq-question">
                <h3>How can I increase my chances of getting more projects?</h3>
                <span className="itc-faq-icon">
                  {activeFaq === 4 ? <X /> : <ChevronRight />}
                </span>
              </div>
              <div className="itc-faq-answer">
                <p>
                  Maintain a high quality score by delivering excellent work,
                  respond promptly to job offers, specialize in high-demand
                  fields, keep your availability calendar updated, complete your
                  profile with portfolio samples, and obtain positive reviews
                  from clients.
                </p>
              </div>
            </div>
      ...
      <section className="itc-cta">
        <div className="itc-cta-content animate">
          ...
          <p>
            Join thousands of language professionals who have found success with
            InterTransConnect
          </p>
